...
function App({
  ...
  return (
    <Shell.Root>
      <Shell.Header />
      <Shell.Sidebar presentation={{ initial: 'fixed' }} resizable minSize={min} maxSize={max} defaultState="expanded" onSizeChange={onSizeChange} sizeUpdate={sizeUpdate} sizeUpdateMs={sizeUpdateMs}>
        sidebar
