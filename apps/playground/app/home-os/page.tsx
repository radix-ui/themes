            ...
            <div className={styles.root}>
              <div
                style={{
                  ...
                  backgroundColor: 'var(--mono1)',
                  background: 'linear-gradient(150deg, transparent 60%, var(--mono2) 100%)',
                }}
              >
                <header
                  style={{
                    padding: 'var(--space-4) var(--space-6)',
                    borderBottom: '1px solid var(--mono8)',
                    display: 'flex',
