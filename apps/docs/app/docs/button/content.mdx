---
title: Button
description: Use buttons to trigger actions throughout your interface. Buttons are promises of what happens next.
source: https://github.com/KushagraDhawan1997/kookie-ui/blob/main/packages/kookie-ui/src/components/button.tsx
---
