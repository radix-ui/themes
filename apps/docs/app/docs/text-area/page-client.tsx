...
interface TextAreaPageClientProps {
  metadata?: DocMetadata;
}

export default function TextAreaPageClient({ metadata }: TextAreaPageClientProps) {
  ...
  return (
    ...
    >
      {activeTab === 'docs' ? <ContentMDX /> : <TextAreaExamples />}
    </SiteDocsPage>
  );
}
