import { Button, Flex, Box, Text, Callout, IconButton, Theme, Section, Separator, Badge } from '@kushagradhawan/kookie-ui';
...
<CodeBlock
  ...
  preview={
    <Flex gap="2" align="center" justify="center" wrap="wrap" width="100%">
      ...
      <Button size="4" color="" variant="solid" material="translucent">Button</Button>
