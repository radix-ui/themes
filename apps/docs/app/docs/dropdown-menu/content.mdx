...
| Key                     | Action                                          |
| ----------------------- | ----------------------------------------------- |
| `Space` / `Enter`       | Opens menu from trigger, selects focused item   |
| `Arrow Down`            | Opens menu from trigger, moves focus down       |
| `Arrow Up`              | Moves focus up, wraps from first to last        |
| `Arrow Right`           | Opens submenu when focused on SubTrigger        |
| `Arrow Left`            | Closes submenu, returns focus to SubTrigger     |
