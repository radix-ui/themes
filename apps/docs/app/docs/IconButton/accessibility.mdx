...
**Flush buttons** automatically maintain full accessibility while achieving visual integration. Negative margins affect only visual positioning—the clickable area automatically remains unchanged.
