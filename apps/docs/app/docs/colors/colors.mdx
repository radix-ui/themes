---
title: Colors
description: Accessible color system with 12-step scales, automatic dark mode, and P3 gamut support. All credit for the color system goes to Radix Colors.
source: https://github.com/KushagraDhawan1997/kookie-ui/blob/main/packages/kookie-ui/tokens/colors
---
