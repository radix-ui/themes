...
interface IconButtonPageClientProps {
  metadata?: DocMetadata;
}

export default function IconButtonPageClient({ metadata }: IconButtonPageClientProps) {
  ...
  return (
    ...
    >
      {activeTab === 'docs' ? <ContentMDX /> : <IconButtonExamples />}
    </SiteDocsPage>
  );
}
