import { Table, Text, Code, Box, Callout, Badge, Section, Heading, Flex, Shell, Button } from '@kushagradhawan/kookie-ui';
...
<CodeBlock
  preview={
    <Flex gap="2" align="center" wrap="wrap">
      ...
      <Shell.Trigger target="inspector" aria-label="Open property inspector">
        <Button size="2" variant="ghost">⚙️</Button>
      </Shell.Trigger>
      <Shell.Trigger target="bottom" aria-label="Toggle bottom panel">
        <Button size="2" variant="ghost">📋</Button>
      </Shell.Trigger>
    </Flex>
  }
