import { Table, Text, Code, Box, Callout, Badge, Section, Heading, Card, Flex, Shell } from '@kushagradhawan/kookie-ui';
...
The Shell component is designed around core layout principles that prioritize predictability, composition rules, and responsive behavior. These guidelines help you build interfaces that feel consistent and work reliably across different screen sizes and usage patterns.
...
Best for applications with hierarchical navigation where users need both quick section switching and detailed navigation.

<CodeBlock
  preview={
    <div style={{ height: '300px', border: '1px solid var(--gray-6)', borderRadius: '8px', overflow: 'hidden' }}>
      <Shell.Root height="100%">
        <Shell.Header style={{ background: 'var(--gray-2)', padding: '0 16px', display: 'flex', alignItems: 'center' }}>
          <Text size="2" weight="medium">App Navigation</Text>
        </Shell.Header>
        <Shell.Rail defaultSize={64} style={{ background: 'var(--gray-3)' }}>
          <div style={{ padding: '8px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
            <div style={{ width: '24px', height: '24px', background: 'var(--gray-6)', borderRadius: '4px' }}></div>
            <div style={{ width: '24px', height: '24px', background: 'var(--gray-6)', borderRadius: '4px' }}></div>
            <div style={{ width: '24px', height: '24px', background: 'var(--gray-6)', borderRadius: '4px' }}></div>
          </div>
        </Shell.Rail>
        <Shell.Panel defaultSize={200} style={{ background: 'var(--gray-2)' }}>
          <div style={{ padding: '16px' }}>
            <Text size="2" weight="medium" mb="2">Navigation</Text>
            <Text size="1" color="gray">Detailed navigation for current section</Text>
          </div>
        </Shell.Panel>
        <Shell.Content style={{ background: 'var(--gray-1)', padding: '24px' }}>
          <Text size="3" weight="medium" mb="2">Main Interface</Text>
          <Text size="2" color="gray">Primary application content area</Text>
        </Shell.Content>
      </Shell.Root>
    </div>
  }
...
Best for applications with unified navigation where all navigation lives in a single expandable area.
...
Minimal pattern for focused applications.
