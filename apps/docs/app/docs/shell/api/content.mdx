  ...
  <Table.Root mt="6" mb="9" size="2" variant="ghost">
    ...
    <Table.Body>
      <Table.Row>
        ...
        <Table.Cell>Controls the height of the shell container. Defaults to `'full'` (100vh).</Table.Cell>
      </Table.Row>
      <Table.Row>
  ...
  <Table.Root mt="6" mb="9" size="2" variant="ghost">
    ...
    <Table.Body>
      ...
      <Table.Row>
        ...
        <Table.Cell>`(open: boolean, meta: { reason: 'init' | 'toggle' }) => void`</Table.Cell>
  ...
  <Table.Root mt="6" mb="9" size="2" variant="ghost">
    ...
    <Table.Body>
      ...
      <Table.Row>
        ...
        <Table.Cell>`number`</Table.Cell>
        <Table.Cell>Minimum width when resizing. Defaults to 100.</Table.Cell>
      </Table.Row>
      <Table.Row>
      ...
      <Table.Row>
        ...
        <Table.Cell>`React.ReactNode`</Table.Cell>
        <Table.Cell>Custom content inside the resizer handle (kept unstyled). Use `Panel.Handle` child component instead.</Table.Cell>
      </Table.Row>
      <Table.Row>
  ...
  <Table.Root mt="6" my="6" size="2" variant="ghost">
    ...
    <Table.Body>
      ...
      <Table.Row>
        ...
        <Table.Cell>`(state: SidebarMode, meta: { reason: 'init' | 'toggle' }) => void`</Table.Cell>
      ...
      <Table.Row>
        <Table.RowHeaderCell>`resizer`</Table.RowHeaderCell>
        <Table.Cell>`React.ReactNode`</Table.Cell>
        <Table.Cell>Custom content inside the resizer handle (kept unstyled). Use `Sidebar.Handle` child component instead.</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.RowHeaderCell>`onResize`</Table.RowHeaderCell>
        <Table.Cell>`(size: number) => void`</Table.Cell>
  ...
  <Table.Root mt="6" mb="9" size="2" variant="ghost">
    ...
    <Table.Body>
      ...
      <Table.Row>
        <Table.RowHeaderCell>`resizer`</Table.RowHeaderCell>
        <Table.Cell>`React.ReactNode`</Table.Cell>
        <Table.Cell>Custom content inside the resizer handle (kept unstyled). Use `Inspector.Handle` child component instead.</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.RowHeaderCell>`onResize`</Table.RowHeaderCell>
        <Table.Cell>`(size: number) => void`</Table.Cell>
  ...
  <Table.Root mt="6" mb="9" size="2" variant="ghost">
    ...
    <Table.Body>
      ...
      <Table.Row>
        <Table.RowHeaderCell>`resizer`</Table.RowHeaderCell>
        <Table.Cell>`React.ReactNode`</Table.Cell>
        <Table.Cell>Custom content inside the resizer handle (kept unstyled). Use `Bottom.Handle` child component instead.</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.RowHeaderCell>`onResize`</Table.RowHeaderCell>
        <Table.Cell>`(size: number) => void`</Table.Cell>
...
import { 
  ...
  useComposition,
  usePresentation
} from '@kushagradhawan/kookie-ui/components/shell.context';
...
Resolve responsive values against the current breakpoint.
...
// Returns current resolved value
console.log(value); // 'collapsed' | 'expanded'
```
...
type SidebarStateChangeMeta = { reason: 'init' | 'toggle' };
type SidebarSizeChangeMeta = { reason: 'init' | 'resize' | 'controlled' };
type PaneOpenChangeMeta = { reason: 'init' | 'toggle' | 'left' };
type PaneSizeChangeMeta = { reason: 'init' | 'resize' | 'controlled' };

// Hook return types
type UseLeftModeReturn = { leftMode: PaneMode; setLeftMode: (mode: PaneMode) => void };
type UsePanelModeReturn = { panelMode: PaneMode; setPanelMode: (mode: PaneMode) => void };
type UseSidebarModeReturn = { sidebarMode: SidebarMode; setSidebarMode: (mode: SidebarMode) => void };
type UseInspectorModeReturn = { inspectorMode: PaneMode; setInspectorMode: (mode: PaneMode) => void };
type UseBottomModeReturn = { bottomMode: PaneMode; setBottomMode: (mode: PaneMode) => void };
...
<Callout.Root variant="surface" size="2" color="orange" my="6" highContrast><Callout.Text>The Shell component enforces specific composition rules to maintain layout consistency and prevent conflicting arrangements.</Callout.Text></Callout.Root>
...
<Callout.Root variant="surface" size="2" color="red" highContrast my="6"><Callout.Text>The following combinations will trigger console warnings and may cause layout conflicts.</Callout.Text></Callout.Root>
...
- `Shell.Rail` - Navigation container (no specific ARIA role)
- `Shell.Panel` - Sidebar container (no specific ARIA role)
- `Shell.Sidebar` - Alternative navigation container (no specific ARIA role)
- `Shell.Content` - Main landmark for primary content
- `Shell.Inspector` - Right panel container (no specific ARIA role)
- `Shell.Bottom` - Bottom panel container (no specific ARIA role)
