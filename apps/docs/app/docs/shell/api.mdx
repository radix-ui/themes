  ...
  <Table.Root mt="6" mb="9" size="2" variant="ghost">
    ...
    <Table.Body>
      ...
      <Table.Row>
        ...
        <Table.Cell>`Array<'thin' | 'expanded'>`</Table.Cell>
        <Table.Cell>Available modes in toggle sequence. Defaults to `['thin', 'expanded']`.</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.RowHeaderCell>`resizable`</Table.RowHeaderCell>
        <Table.Cell>`boolean`</Table.Cell>
  ...
  <Table.Root mt="6" mb="9" size="2" variant="ghost">
    ...
    <Table.Body>
      ...
      <Table.Row>
        ...
        <Table.Cell>`boolean | 'collapsed'`</Table.Cell>
        <Table.Cell>Whether to show peek preview on hover. If `'collapsed'`, only peeks when target is collapsed. Defaults to false.</Table.Cell>
      </Table.Row>
      <Table.Row>
        <Table.RowHeaderCell>`children`</Table.RowHeaderCell>
        <Table.Cell>`React.ReactNode`</Table.Cell>
