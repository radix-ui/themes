---
title: Typography
description: Typography system with 10-step scale (0-9), font weights, and formatting components. Kookie UI uses custom typography values that differ from Radix Themes.
