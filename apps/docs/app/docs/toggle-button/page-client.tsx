...
import { ToggleButtonExamples } from './examples';
import type { DocMetadata } from '@/lib/frontmatter';

interface ToggleButtonPageClientProps {
  metadata?: DocMetadata;
}

export default function ToggleButtonPageClient({ metadata }: ToggleButtonPageClientProps) {
  ...
  return (
    ...
    >
      {activeTab === 'docs' ? <ContentMDX /> : <ToggleButtonExamples />}
    </SiteDocsPage>
  );
}
