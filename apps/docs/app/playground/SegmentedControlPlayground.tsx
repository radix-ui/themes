            ...
            <Table.Root>
              ...
              <Table.Body>
                <Table.Row>
                  ...
                  <Table.Cell>
                    <SegmentedControl.Root defaultValue="home" size="2">
                      <SegmentedControl.Item value="home">
                        <Home />
                      </SegmentedControl.Item>
                      <SegmentedControl.Item value="search">
                        <Search />
                      </SegmentedControl.Item>
                ...
                <Table.Row>
                  ...
                  <Table.Cell>
                    <Flex direction="column" gap="3">
                      <SegmentedControl.Root defaultValue="home" size="1">
                        <SegmentedControl.Item value="home">
                          <Home />
                          Home
                        </SegmentedControl.Item>
                      ...
                      <SegmentedControl.Root defaultValue="home" size="4">
                        <SegmentedControl.Item value="home">
                          <Home />
                          Home
                        </SegmentedControl.Item>
                ...
                <Table.Row>
                  ...
                  <Table.Cell>
                    <SegmentedControl.Root defaultValue="table" size="2">
                      ...
                      <SegmentedControl.Item value="kanban">
                        <Layers />
                        Kanban
                      </SegmentedControl.Item>
                ...
                <Table.Row>
                  ...
                  <Table.Cell>
                    <SegmentedControl.Root defaultValue="line" size="2">
                      ...
                      <SegmentedControl.Item value="pie">
                        <PieChart />
                        Pie
                      </SegmentedControl.Item>
                      <SegmentedControl.Item value="area">
                        <BarChart3 />
                        Area
                      </SegmentedControl.Item>
                    </SegmentedControl.Root>
                ...
                <Table.Row>
                  ...
                  <Table.Cell>
                    <SegmentedControl.Root defaultValue="pdf" size="2">
                      ...
                      <SegmentedControl.Item value="xlsx">
                        <TableIcon />
                        XLSX
                      </SegmentedControl.Item>
                      <SegmentedControl.Item value="pptx">
                        <Layers />
                        PPTX
                      </SegmentedControl.Item>
                    </SegmentedControl.Root>
