            ...
            <Table.Root>
              ...
              <Table.Body>
                <Table.Row>
                  ...
                  <Table.Cell>
                    <Callout.Root variant="soft" size="2" color="red" role="alert" live="assertive">
                      <Callout.Icon>
                        <XCircle />
                      </Callout.Icon>
            ...
            <Table.Root>
              ...
              <Table.Body>
                <Table.Row>
                  ...
                  <Table.Cell>
                    <Callout.Root role="status" live="polite">
                      <Callout.Icon>
                        <Info />
                      </Callout.Icon>
                      <Callout.Text>Informational message (aria-live="polite")</Callout.Text>
                    </Callout.Root>
                  </Table.Cell>
                  <Table.Cell>
                    <Callout.Root role="alert" live="assertive">
                      <Callout.Icon>
                        <AlertTriangle />
                      </Callout.Icon>
                      <Callout.Text>Critical alert (aria-live="assertive")</Callout.Text>
                    </Callout.Root>
                  </Table.Cell>
                  <Table.Cell>
                    <Callout.Root role="note" live="off">
                      <Callout.Icon>
                        <Lightbulb />
                      </Callout.Icon>
                      <Callout.Text>Note message (aria-live="off")</Callout.Text>
                    </Callout.Root>
                  </Table.Cell>
                </Table.Row>
                <Table.Row>
                  ...
                  <Table.Cell>
                    <Callout.Root role="status" live="polite" highContrast>
                      <Callout.Icon>
                        <Info />
                      </Callout.Icon>
                      <Callout.Text>High contrast status message</Callout.Text>
                    </Callout.Root>
                  </Table.Cell>
                  <Table.Cell>
                    <Callout.Root role="alert" live="assertive" highContrast color="red">
                      <Callout.Icon>
                        <XCircle />
                      </Callout.Icon>
                      <Callout.Text>High contrast critical alert</Callout.Text>
                    </Callout.Root>
                  </Table.Cell>
                  <Table.Cell>
                    <Callout.Root role="note" live="off" highContrast color="green">
                      <Callout.Icon>
                        <CheckCircle />
                      </Callout.Icon>
                      <Callout.Text>High contrast note message</Callout.Text>
                    </Callout.Root>
                  </Table.Cell>
                </Table.Row>
                <Table.Row>
                  ...
                  <Table.Cell>
                    <div dir="rtl">
                      <Callout.Root role="status" live="polite">
                        ...
                        <Callout.Text>RTL status message</Callout.Text>
                      </Callout.Root>
                    </div>
                  </Table.Cell>
                  <Table.Cell>
                    <div dir="rtl">
                      <Callout.Root role="alert" live="assertive" color="red">
                        <Callout.Icon>
                          <AlertTriangle />
                        </Callout.Icon>
                        <Callout.Text>RTL alert message</Callout.Text>
                      </Callout.Root>
                    </div>
                  </Table.Cell>
                  <Table.Cell>
                    <div dir="rtl">
                      <Callout.Root role="note" live="off" color="blue">
                        <Callout.Icon>
                          <Lightbulb />
                        </Callout.Icon>
                        <Callout.Text>RTL note message</Callout.Text>
                      </Callout.Root>
                    </div>
                  </Table.Cell>
                </Table.Row>
              ...
              <Table.Body>
                {(['solid', 'translucent'] as const).map((material) => (
                  <Table.Row key={material}>
                    ...
                    {variants.map((variant) => (
                      <Table.Cell key={variant}>
                        <Callout.Root size="2" variant={variant} material={material}>
                          <Callout.Icon>
                            <Info />
                          </Callout.Icon>
