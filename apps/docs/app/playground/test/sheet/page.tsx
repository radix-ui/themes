    ...
    <Flex direction="column" align="start" p="4" gap="3">
      <Flex gap="3">
        <Sheet.Root open={topSheetOpen} onOpenChange={setTopSheetOpen}>
          ...
          <Sheet.Content side="top" height={{ initial: '280px', md: '360px' }}>
            <Sheet.Title>
        ...
        <Sheet.Root open={bottomSheetOpen} onOpenChange={setBottomSheetOpen}>
          <Sheet.Trigger>
            <Button>Bottom Sheet</Button>
          </Sheet.Trigger>
          <Sheet.Content side="bottom" height={{ initial: '280px', md: '360px' }}>
            <Sheet.Title>
              <VisuallyHidden>Right Sheet</VisuallyHidden>
            </Sheet.Title>
            <Flex direction="column" gap="3" p="3">
