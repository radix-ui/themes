    ...
    <Flex direction="column" gap="6">
      ...
      <Tabs.Root defaultValue="theme-colors">
        <Tabs.List size="2">
          ...
          <Tabs.Trigger value="multiple-thumbs">Multiple thumbs</Tabs.Trigger>
          <Tabs.Trigger value="ticks">Ticks</Tabs.Trigger>
        </Tabs.List>
        ...
        {/* Multiple Thumbs Tab */}
        <Tabs.Content value="multiple-thumbs">
          <Box pt="4">
            <Table.Root>
              <Table.Header>
                <Table.Row>
