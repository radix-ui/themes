              ...
              <Table.Body>
                {sizes.map((size) => (
                  <Table.Row key={size}>
                    ...
                    {variants.map((variant) => (
                      <Table.Cell key={variant}>
                        <Checkbox size={size as any} variant={variant} defaultChecked />
                      </Table.Cell>
                    ))}
                  </Table.Row>
                ))}
            ...
            <Table.Root>
              ...
              <Table.Body>
                ...
                <Table.Row>
                  ...
                  {variants.map((variant) => (
                    <Table.Cell key={variant}>
                      <Checkbox size="2" variant={variant} checked="indeterminate" />
                    </Table.Cell>
                  ))}
                </Table.Row>
                <Table.Row>
                ...
                <Table.Row>
                  ...
                  {variants.map((variant) => (
                    <Table.Cell key={variant}>
                      <Checkbox size="2" variant={variant} disabled defaultChecked />
                    </Table.Cell>
                  ))}
                </Table.Row>
              </Table.Body>
              ...
              <Table.Body>
                {(['solid', 'translucent'] as const).map((material) => (
                  <Table.Row key={material}>
                    ...
                    {variants.map((variant) => (
                      <Table.Cell key={variant}>
                        <Checkbox size="2" variant={variant} material={material} defaultChecked />
                      </Table.Cell>
                    ))}
                  </Table.Row>
                ))}
